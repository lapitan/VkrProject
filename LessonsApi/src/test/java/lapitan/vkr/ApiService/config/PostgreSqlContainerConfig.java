...
public class PostgreSqlContainerConfig {
    ...
    private static final String DB_NAME = "LessonsApiDb";
    private static final String USERNAME = "vkr123";
    private static final String PASSWORD = "vkr123";
...
//            .withInitScript("classpath:sql/init.sql");

    static {
//        POSTGRES.addExposedPort(64069);
        POSTGRES.start();
    }
